...
public class MainActivity extends Activity {
     ...
     * Package Key.
     */
    static String packageKey = "59ec84d0689a7a8db0b4f16ea8edc40b";
...
//        try {
//            stringBuilder.append(getString(R.string.UID)).append(
//                    Utilities.dumpBytes(intagFive.getUID()));
//            stringBuilder.append("\n\n");
//            stringBuilder.append(getString(R.string.SIZE)).append(intagFive.getTotalMemory());
//            stringBuilder.append("\n\n");
//
//            boolean isNxp = intagFive.isNXP();
//            if (isNxp) {
//                stringBuilder.append(getString(R.string.Vendor_ID)).append(getString(R.string
// .NXP));
//                stringBuilder.append("\n\n");
//
//            } else {
...
//                    R.string.Max_Trans_length_value));
//            stringBuilder.append("\n\n");
//            out = intagFive.readSingleBlock(ICode.NFCV_FLAG_ADDRESS, DEFAULT_ICode_PAGE);
//        } catch (Exception e) {
//            stringBuilder.append(UNABLE_TO_READ);
//        }
//        showMessage(stringBuilder.toString(), PRINT);
